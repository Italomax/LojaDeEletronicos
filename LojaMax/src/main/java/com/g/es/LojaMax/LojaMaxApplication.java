...
import com.g.es.LojaMax.repositories.ProductRepository;

@SpringBootApplication
public class LojaMaxApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(LojaMaxApplication.class, args);
	}
